...
class NestedFieldTestCase(unittest.TestCase):
    def test_nested_fields(self):
        json_data = {"username": "John Doe", "balance": 12345, "settings": {"is_public": True}}
    ...
    def test_nested_fields_from_proto(self):
        protobuf = Account(username="John Doe", balance=12345, settings=AccountSettings(is_public=True))
